...
void main()
{
	...
	vec4 Color_reflection = 0.8*texture(SkyboxTexture,R);
	...
	vec4 Color_refraction = texture(SkyboxTexture,refraction);

	/*Final Color*/

	fColor = Color_water + Color_reflection * fresnel + Color_refraction * (1-fresnel); 
